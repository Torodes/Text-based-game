...
//Events
	...
	//4 Hills
		void e4a(){
			...
			p.set_has_shelter(true);
			p.set_daysoffood(2);
			cout << "You move through the hilly area and stomble uppon an empty camp. with a fire spot, 2 days of food supply and a worn out tent. even though it has holes, you can use this as a -shelter- and always return here.\n You've gained:\n 2 days of food\n A new shelter\n";
...
//Prints	
	...
	//4 Hills
		//Main
			void p4m(){
				cout << "You walk onto a small hill nearby to get a better view. You look to the left and see a big -forest-, straight you see a big smoke plume next to a -lake- and a -swamp- behind that.\n";
		...
		//to
			...
			//p4_5(){}
			void p4_6(){
			cout << "You walk down the hill carefully so you don't trip. You start making your way to the Lake. It is a long way, but there are a ton of interesting flowers aroud you so your mind is occupied and the walk goes over quickly.\n";
			}
			void p4_7(){
			cout << "You walk down the hill carefully so you don't trip. The swamp is far away, being on the other side of the plains. As you get closer to the swamp see how the ground around you gets less and less unstable.\n\n";
			}
	//6 Lake
		//Main
			void p6m(){
